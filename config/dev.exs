...
config :querylogging, QueryloggingWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "o3N6VvYsN1kxQ9P7S1LjgkEkEmX120kqIVwzqaQ3LowAyTG2MEo7U3R79Zi9Ar47",
  watchers: [
...
config :querylogging, QueryloggingWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/querylogging_web/(controllers|live|components)/.*(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :querylogging, dev_routes: true
